...
class Serializable(object):
    """
    From openai/rllab we don't take a dependency on rllab itself because it is being
    deprecated and additionally it is difficult to install!!

    This is a simple class that makes serialization convenient.
    """
