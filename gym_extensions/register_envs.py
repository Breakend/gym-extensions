...
custom_envs = {
            ...
            "HumanoidStandupWithSensor-v0" :
                dict(path='gym_extensions.continuous.modified_humanoid:HumanoidStandupWithSensorEnv',
                     max_episode_steps=1000,
            ...
            "HopperBigTorso-v0" :
                dict(path='gym_extensions.continuous.modified_hopper:HopperModifiedBodyPartSizeEnv',
                     max_episode_steps=1000,
                     reward_threshold=3800.0,
            ...
            "Walker2dBigTorso-v0" :
                dict(path='gym_extensions.continuous.modified_walker2d:Walker2dModifiedBodyPartSizeEnv',
                     max_episode_steps=1000,
                     kwargs= dict(body_parts=["torso_geom"], size_scale=1.25)),
            "Walker2dBigThigh-v0" :
                dict(path='gym_extensions.continuous.modified_walker2d:Walker2dModifiedBodyPartSizeEnv',
